...
class KTBootstrap
{
    ...
    {
        setModeSwitch(config('metronic.KT_THEME_MODE_SWITCH_ENABLED'));
        setModeDefault(config('metronic.KT_THEME_MODE_DEFAULT'));
    }
    ...
    {
        setDirection(config('metronic.KT_THEME_DIRECTION'));
