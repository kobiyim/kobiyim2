...
class Menu
{
    ...
    public static function renderVerMenu($item, $parent = null, $rec = 0, $singleItem = false)
    {
        ...
        if (isset($item['can']) and ! can($item['can'])) {
        } else {
            if (isset($item['separator'])) {
                ...
                } elseif (config('theme.layout.aside.menu.hide-root-icons') !== true && isset($item['icon']) && ! empty($item['icon'])) {
                ...
                if (isset($item['submenu'])) {
                    if (isset($item['root']) == false && config('theme.layout.menu.aside.submenu.arrow') == 'plus-minus') {
                        echo '<i class="menu-arrow menu-arrow-pm"><span><span></span></span></i>';
                    } elseif (isset($item['root']) == false && config('theme.layout.menu.aside.submenu.arrow') == 'plus-minus-square') {
                        echo '<i class="menu-arrow menu-arrow-pm-square"><span><span></span></span></i>';
                    } elseif (isset($item['root']) == false && config('theme.layout.menu.aside.submenu.arrow') == 'plus-minus-circle') {
                        echo '<i class="menu-arrow menu-arrow-pm-circle"><span><span></span></span></i>';
                    } else {
                        if (@$item['arrow'] !== false && config('theme.layout.aside.menu.root-arrow') !== false) {
                ...
                if (isset($item['submenu'])) {
                    ...
                    foreach ($item['submenu'] as $submenu_item) {
                        self::renderVerMenu($submenu_item, $item, $rec++, $singleItem);
                    }
                    echo '</ul>';
                ...
                foreach ($item as $each) {
                    self::renderVerMenu($each, $parent, $rec++, $singleItem);
                }
            }
        }
    }
                ...
                if (isset($item['code'])) {
                    ...
                    if (isset($item['submenu']) && (! isset($item['arrow']) || $item['arrow'] != false)) {
                        ...
                        if (isset($item['root'])) {
                            ...
                            if (config('theme.layout.header.menu.self.root-arrow') !== false) {
