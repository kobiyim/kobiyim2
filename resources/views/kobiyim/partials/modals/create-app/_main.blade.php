				...
				<div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="kt_modal_create_app_stepper">
					...
					<div class="flex-row-fluid py-lg-5 px-lg-15">
						...
						<form class="form" novalidate="novalidate" id="kt_modal_create_app_form">
							@include('kobiyim/partials/modals/create-app/steps/_step-1')
							@include('kobiyim/partials/modals/create-app/steps/_step-2')
							@include('kobiyim/partials/modals/create-app/steps/_step-3')
							@include('kobiyim/partials/modals/create-app/steps/_step-4')
							@include('kobiyim/partials/modals/create-app/steps/_step-5')
							<!--begin::Actions-->
