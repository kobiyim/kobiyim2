				...
				<div class="timeline">
					...
					<div class="timeline-item">
						...
						<div class="timeline-icon symbol symbol-circle symbol-40px">
							<div class="symbol-label bg-light">{!! getIcon('flag', 'fs-2 text-gray-500') !!}</div>
						</div>
						<!--end::Timeline icon-->
						<!--begin::Timeline content-->
					...
					<div class="timeline-item">
						...
						<!--begin::Timeline icon-->
						<div class="timeline-icon symbol symbol-circle symbol-40px">
							<div class="symbol-label bg-light">{!! getIcon('disconnect', 'fs-2 text-gray-500') !!}</div>
						</div>
						<!--end::Timeline icon-->
						<!--begin::Timeline content-->
						<div class="timeline-content mb-10 mt-n1">
					...
					<div class="timeline-item">
						...
						<!--begin::Timeline icon-->
						<div class="timeline-icon symbol symbol-circle symbol-40px">
							<div class="symbol-label bg-light">{!! getIcon('abstract-26', 'fs-2 text-gray-500') !!}</div>
						</div>
						<!--end::Timeline icon-->
						<!--begin::Timeline content-->
						<div class="timeline-content mb-10 mt-n1">
					...
					<div class="timeline-item">
						...
						<!--begin::Timeline icon-->
						<div class="timeline-icon symbol symbol-circle symbol-40px">
							<div class="symbol-label bg-light">{!! getIcon('pencil', 'fs-2 text-gray-500') !!}</div>
						</div>
						<!--end::Timeline icon-->
						<!--begin::Timeline content-->
						<div class="timeline-content mb-10 mt-n1">
					...
					<div class="timeline-item">
						...
						<!--begin::Timeline icon-->
						<div class="timeline-icon symbol symbol-circle symbol-40px">
							<div class="symbol-label bg-light">{!! getIcon('sms', 'fs-2 text-gray-500') !!}</div>
						</div>
						<!--end::Timeline icon-->
						<!--begin::Timeline content-->
						<div class="timeline-content mb-10 mt-n1">
					...
					<div class="timeline-item">
						...
						<div class="timeline-content mb-10 mt-n1">
							...
							<!--begin::Timeline details-->
							<div class="overflow-auto pb-5">
								@include('kobiyim/partials/general/_notice')
							</div>
							<!--end::Timeline details-->
						</div>
						<!--end::Timeline content-->
					...
					<div class="timeline-item">
						...
						<!--begin::Timeline icon-->
						<div class="timeline-icon symbol symbol-circle symbol-40px">
							<div class="symbol-label bg-light">{!! getIcon('basket', 'fs-2 text-gray-500') !!}</div>
						</div>
						<!--end::Timeline icon-->
						<!--begin::Timeline content-->
