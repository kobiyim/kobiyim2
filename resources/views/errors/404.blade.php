...
<html lang="en" >
    <!--begin::Head-->
    <head>
        <title>404 Bulunamadı | KOBİYİM</title>
        <!-- Google Tag Manager -->
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700"/>        <!--end::Fonts-->
                    ...
                    <!--begin::Page Custom Styles(used by this page)-->
                             <link href="{{ asset('css') }}/pages/error/error-5.css?v=7.2.9" rel="stylesheet" type="text/css"/>
...
<link href="{{ asset('css') }}/themes/layout/header/base/light.css?v=7.2.9" rel="stylesheet" type="text/css"/>
<link href="{{ asset('css') }}/themes/layout/header/menu/light.css?v=7.2.9" rel="stylesheet" type="text/css"/>
<link href="{{ asset('css') }}/themes/layout/brand/dark.css?v=7.2.9" rel="stylesheet" type="text/css"/>
<link href="{{ asset('css') }}/themes/layout/aside/dark.css?v=7.2.9" rel="stylesheet" type="text/css"/>        <!--end::Layout Themes-->
...
<!--end::Main-->
    ...
    "font-family": "Poppins"
    	...
    	<!--begin::Global Theme Bundle(used by all pages)-->
    	            <script src="{{ asset('plugins') }}/global/plugins.bundle.js?v=7.2.9"></script>
		            <script src="{{ asset('plugins') }}/custom/prismjs/prismjs.bundle.js?v=7.2.9"></script>
		            <script src="{{ asset('js') }}/scripts.bundle.js?v=7.2.9"></script>
